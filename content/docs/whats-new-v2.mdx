---
title: OpenDataLoader PDF v2.0 – PDF to Markdown for RAG, 100+ pages/sec, no GPU
description: OpenDataLoader PDF v2.0 release highlights: top benchmark performance, four free AI Add-ons, Apache 2.0 license, LangChain integration
---

# OpenDataLoader PDF v2.0 is out!

OpenDataLoader PDF v2.0 features a hybrid engine that combines AI-based and deterministic extraction methods. This results in both high quality in data extraction and high performance. OpenDataLoader can be used free of charge in a fully airgapped local environment, eliminating any risk of data leakage to external servers.
